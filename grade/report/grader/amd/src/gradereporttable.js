    ...
    return /** @alias module:gradereport_grader/gradereporttable */ {
        initialise: function() {
            ...
            PubSub.subscribe('stk:responsive-susses', function(data) {
                ...
                stickyTable.wrapperSticky.hide();
                stickyTable.wrapperSticky.css('width', parseInt(main.innerWidth()) - parseInt(main.css('paddingLeft')));
                stickyTable.wrapperSticky.show();
            });
